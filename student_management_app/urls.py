...
urlpatterns = [
    ...
    path('edit_discussion/<pk: post_id>', HodViews.edit_discussion, name="edit_discussion"),
    path('edit_discussion_save/<pk: post_id>', HodViews.edit_discussion_save, name="edit_discussion_save"),
