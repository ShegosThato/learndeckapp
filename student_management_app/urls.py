...
urlpatterns = [
    ...
    path('edit_discussion/<post_id>', HodViews.edit_discussion, name="edit_discussion"),
    path('edit_discussion_save/<post_id>', HodViews.edit_discussion_save, name="edit_discussion_save"),
